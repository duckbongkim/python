...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('article', '0008_answer_modity_date_question_modify_date'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='question',
            name='author',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author_queserion', to=settings.AUTH_USER_MODEL),
        ),
    ]
